...
- [Android Sync framework — source.android.com](https://source.android.com/docs/core/graphics/sync)

详见 [[05-Fence与跨SoC同步]]｜跨核 [[composer_stub]]｜信号 [[SIGSEGV]]｜安全 [[SELinux]]｜判定 [[退出码101 vs SIGSEGV（composer_stub 崩溃判定）]]｜主线程 [[SurfaceFlinger 主线程与三阶段]]｜上级 [[000-GFWK图形框架总览]]
